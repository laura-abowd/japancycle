...
Cycle.create!(user: users.sample,  brand: "Cannondale", color: 'black', category: 'electric', price: '30000', town: "Otaku", description: 'like new!', location: 'Otaku, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2519999.jpg')
...
Cycle.create!(user: users.sample,  brand: "Peugeot", color: 'golden', category: 'vintage', price: '10000', town: "Setagaya", description: 'negotiable', location: 'Setagaya, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2518513.jpg')
Cycle.create!(user: users.sample,  brand: "BMC", color: 'black', category: 'urban', price: '30000', town: "Ikebukuro", description: 'willing to negotiate', location: 'Ikebukuro, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2519238.jpg')
Cycle.create!(user: users.sample,  brand: "Specialized", color: 'green', category: 'mountain', price: '15000', town: "Sagamihara", description: 'Pick-up only plz', location: 'Sagamihara, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2491171.jpg')
...
Cycle.create!(user: users.sample,  brand: "Mondraker", color: 'orange', category: 'mountain', price: '15000', town: "Shinjuku", description: 'had for a year', location: 'Shinjuku, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2483047.jpg')
Cycle.create!(user: users.sample,  brand: "Giant", color: 'blue', category: 'mountain', price: '12000', town: "Shibuya", description: 'serious inquiries only', location: 'Shibuya, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2520467.jpg')
Cycle.create!(user: users.sample,  brand: "Shimano", color: 'green', category: 'road', price: '10000', town: "Meguro", description: 'non negotiable', location: 'Meguro, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2508716.jpg')
Cycle.create!(user: users.sample,  brand: "Look cycles", color: 'red', category: 'road', price: '30000', town: "Meguro", description: 'pick-up only', location: 'Meguro, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2457692.jpg')
Cycle.create!(user: users.sample,  brand: "Kalkhoff", color: 'black', category: 'urban', price: '15000', town: "Shibuya", description: 'like new!', location: 'Shibuya, Tokyo', photo: 'https://media.troc-velo.com/bikes/img0n2520603.jpg')
